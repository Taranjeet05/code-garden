...
function longestConsecutive(nums) {
  ...
  const numSet = new Set(nums); // Store all numbers in a Set for quick lookup
  let longestStreak = 0;
...
console.log(longestConsecutive([1,2,3,4,5])); // Output: 5
console.log(longestConsecutive([10,9,8,7,6,5])); // Output: 6