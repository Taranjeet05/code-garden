var Party;
(function (Party) {
    Party["BJP"] = "BJP (Bhartiya Janta Party)";
    Party["CONGRESS"] = "congress";
    Party["Aap"] = "Aap";
})(Party || (Party = {}));
var person = {
    ...
    lifeGoal: "To build digital solutions that make education accessible for all - especially disabled children.",
};
